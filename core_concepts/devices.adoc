...
Allows you to launch, manage and watch status of any linux application. It doesn’t support live provisioning
but expects the device owner to provision the software code on the device.
