...
#### Bugfixes
* After you finish creating a build in the **Create new build** page, the **Show Build** button is supposed to take you to the **Build Details** page, but instead, it was taking you to the **Development>Builds** page. This issue is fixed.
