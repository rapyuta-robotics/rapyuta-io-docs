...
| ------- | ---- | ----------- |
|[User Groups](/how-to-guides/account-management/managing-users/) | New | You can now create user groups to enable the org admin and the group’s creator to manage access to projects.|
...
* While inviting a user, if the user limit is exhausted, an error message wasn't displayed. This issue is now fixed.
