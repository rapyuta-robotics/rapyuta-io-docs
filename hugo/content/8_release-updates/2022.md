...
| ------- | ---- | ----------- |
| [Nominate the Project Admin](/how-to-guides/account-management/managing-projects/#nominate-project-admin) | New | The org or the project admin can nominate another project member as the admin of that project.|

### Bug Fix

Multiple log lines that were present within the same milliseconds timestamp are now sorted according to nanoseconds.
