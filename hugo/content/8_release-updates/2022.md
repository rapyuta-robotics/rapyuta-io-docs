...
* When a user searches for a file name in the table view of the Manage Device Logs page, the search results were reflected only on the current page, the search context was lost when the user navigated to a different page. This issue is now fixed.
