...
| ------- | ----- | ---------- |
| [Managing User Profiles](/how-to-guides/account-management/managing-user-profiles/) | New | You can now manage your profile by:<br> * Update your first and last name. <br> * Update your email address. <br> * Join multiple organizations. |
| [User Metrics](/5_deep-dives/54_tooling-and-debugging/545_user_metrics/) | New | Metrics help you to monitor applications. rapyuta.io platform can now collect device and cloud user metrics. |
