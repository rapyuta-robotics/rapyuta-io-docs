...
* Once the old deployment log files reached a certain size, the telegraph on device was not processing the new deployment log files. This issue is now fixed.
