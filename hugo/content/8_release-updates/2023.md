...
| Paramsync for device deployment (CLI only) | New | Device deployments now offer the capability to synchronize parameters with cloud configurations. |
| Support for onboarding ARCH64 devices | New | Added support for ARCH64 devices on rapyuta.io. |
