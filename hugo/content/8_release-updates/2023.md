...
| [JSON configurations](/3_how-tos/32_device-management/324_applying-configuration-on-devices/) | New | You can now create a configuration parameter in JSON file format. | 
| UI Improvements | Improvement | <ul><li>Catalog is now renamed to Packages</li>.<br> <li> While adding a package with the executable type as docker with a private image, you can access the quick link to add secrets. </li></ul>|
