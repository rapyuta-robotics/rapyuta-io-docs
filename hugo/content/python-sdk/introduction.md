...
```bash
pip install https://storage.googleapis.com/rio-sdk-python/rapyuta_io-0.6.0-py2-none-any.whl
```
If you are using an old version of the Python SDK, please upgrade to the latest
[0.6.0](https://storage.googleapis.com/rio-sdk-python/rapyuta_io-0.6.0-py2-none-any.whl)
version.
