...
{{% tab name="UI" %}}
 ...
 2. To create a new project:
    ...
    Only an org admin or a project creator can enable/disable VPN on projects. For more information, see [Enabling VPN Services](/3_how-tos/34_networking-and-communication/347_enable-vpn/)
