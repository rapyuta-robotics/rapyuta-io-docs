...
{{%/notice%}} |
|Device Resource Limit (optional) | Users now have the option to apply CPU and memory limits for devices using the following command in the CLI:``rio apply riocli/apply/manifests/package-nonros-device.yaml``. {{%notice info%}} Max Executable CPU is 256 cores {{%/notice%}} |
