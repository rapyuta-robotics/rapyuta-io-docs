...
| DEP_E171 | network bridge encountered duplicate alias on the device. | change the alias name during deployment and ensure that there is no duplication of  alias name under the same routed network. For more information about alias, [click here.](/developer-guide/manage-software-cycle/communication-topologies/ros-support/#ros-environment-aliases-runtime-identity-assignment)</a> |
| DEP_E172 | compression library required for the network bridge is missing on the device. | re-onboard the device.</a> |
| DEP_E173 | transport libraries required for the network bridge is missing on the device. | re-onboard the device.</a> |
| DEP_E174 | network bridge on the device encountered multiple ROS service origins. | do not add multiple deployments with the same ROS service endpoint under the same routed network.</a> |
| DEP_E175 | python actionlib/msgs required for the network bridge is missing on the device. | re-onboard the device.</a> |
| DEP_E176 | network bridge encountered duplicate alias on the cloud component. | re-onboard the device.</a> |
| DEP_E177 | network bridge on the cloud component encountered multiple ROS service origins. | re-onboard the device.</a> |
