...
| DEP_E162 | invalid device configuration variables like ros_distro, runtime, CPU architecture | check the associated error message |
| DEP_E163 | application has stopped and exited unexpectedly, and crashes continuously | debug the corresponding deployment logs |
