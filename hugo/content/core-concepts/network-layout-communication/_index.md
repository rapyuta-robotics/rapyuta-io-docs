...
{{% notice note %}}
If you experience the error: ***incoming connection failed: unable to receive data from sender, check sender's logs for details***, please ignore it. As the error cannot be fixed you ***can still continue*** using the platform and finish your work.
{{% /notice %}}
