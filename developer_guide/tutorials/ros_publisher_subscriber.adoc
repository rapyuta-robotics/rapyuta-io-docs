...
... Finally, rapyuta.io needs to know what to launch from the repository, as it might have many packages and roslaunch files. Therefore, add
the command `roslaunch talker talker.launch` in the command field.
+
