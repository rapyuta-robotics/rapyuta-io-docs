...
1. Download the image from link:https://drive.google.com/file/d/14jAm71TMTEcwd-VDagovpIhQMmQKhWJC/view[custom rapyuta image] or
link:https://ubuntu-pi-flavour-maker.org/download/[ubuntu pi flavour] or link:https://wiki.ubuntu.com/ARM/RaspberryPi[ubuntu classic].

[TIP]
====
If you use our link:https://drive.google.com/file/d/14jAm71TMTEcwd-VDagovpIhQMmQKhWJC/view[custom rapyuta image] you can skip after step 6,
and continue to *Setting the Raspberry Pi as rapyuta.io device*.
====
