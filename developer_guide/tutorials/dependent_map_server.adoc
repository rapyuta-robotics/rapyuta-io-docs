...
Finally, we will use configuration parameters to tell rapyuta.io which package and which
launchfile to execute from inside the github repository. Add two configuration parameters
